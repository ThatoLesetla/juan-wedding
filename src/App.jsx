...
const accommodation = [
  {
    name: "Le Bac Estate",
    distance: "Nearby stay",
    tier: "Estate accommodation",
    url: "https://share.google/TT1Dqqk9gJ49ELDM2",
    img: "https://pink-book.co.za/wp-content/uploads/2025/03/LeBac-Estate-Paarl-8.png",
  },
  {
    name: "Nantes Vue Guest House",
    distance: "2 min from venue",
    tier: "Most budget-friendly",
    url: "https://www.nantes-vue.co.za/nantesvuegeusthouse/",
  ...
  },
  {
    ...
    url: "https://underoaks.co.za/accommodation/",
  ...
  },
  {
    ...
    tier: "Moderate",
    url: "https://www.zonnevangerguesthouse.co.za/",
  ...
  },
  {
    ...
    tier: "Refined stay",
    url: "https://canaguesthouse.co.za/",
...
function HoneymoonFundSection({ fundSpotlight }) {
  return (
...
export default function WeddingWebsite() {
  ...
  return (
    ...
    <main className="min-h-screen scroll-smooth">
      <div className="min-h-screen overflow-hidden bg-[#FCF7F2] text-[#4C3A5F]">
            ...
            <div className="mt-8 flex flex-col items-center gap-2">
              <div className="flex items-center gap-2 text-[#E7D7EF]">
                ...
                <a
                  ...
                  className="font-semibold tracking-widest uppercase text-sm transition-colors hover:text-white"
                >
                  Nantes Estate
                </a>
              </div>
                ...
                <div className="grid gap-10 md:grid-cols-[1fr_1.2fr] md:items-center">
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-3 inline-flex font-serif text-4xl text-[#4C3A5F] transition-colors hover:text-[#8F6FA0]"
                    >
                      Nantes Estate
                    </a>
                    <p className="mt-2 text-sm leading-7 text-[#66536F]">R45, Noorderpaarl, Paarl, 7620</p>
                  </div>
                  <div className="space-y-4 text-sm leading-7 text-[#66536F]">
                    ...
                    <p><span className="font-semibold text-[#4C3A5F]">Reception:</span> To follow at Nantes Estate</p>
                    <p><span className="font-semibold text-[#4C3A5F]">Address:</span> R45, Noorderpaarl, Paarl, 7620</p>
                    ...
                    >
                      <MapPin size={14} /> Open Nantes Estate
                    </a>
                  </div>
                </div>
              </CardContent>
        ...
        <HoneymoonFundSection fundSpotlight={fundSpotlight} />

        {/* ── RSVP ── */}
        <Section id="rsvp" eyebrow="RSVP" title="RSVP to Taylor" className="bg-white/55">
                ...
                {rsvpSent ? (
                  ...
                  >
                    ...
                    <p className="mt-3 leading-7 text-[#66536F]">
                      Your WhatsApp RSVP to Taylor is ready to send. We cannot wait to celebrate with you.
                    </p>
                  </motion.div>
                ) : (
                  <motion.form
                  ...
                  >
                    ...
                    <Button className="rounded-full bg-[#A989B6] py-6 text-white hover:bg-[#9578A5] text-base">
                      Send RSVP to Taylor on WhatsApp ✦
                    </Button>
                  </motion.form>
                )}
              </AnimatePresence>
        ...
        <footer className="relative z-10 bg-[#4C3A5F] px-4 py-16 text-center text-white">
          ...
          <blockquote className="mx-auto mt-6 max-w-2xl font-serif text-2xl italic leading-snug text-white sm:text-3xl">
            "Two people are better off than one, for they can help each other succeed."
          </blockquote>
          <p className="mt-4 text-sm uppercase tracking-[0.3em] text-[#DCCAEA]">Ecclesiastes 4:9</p>
